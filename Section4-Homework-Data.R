...
rownames(FreeThrows) <- c("KobeBryant","JoeJohnson","LeBronJames","CarmeloAnthony","DwightHoward","ChrisBosh","ChrisPaul","KevinDurant","DerrickRose","DwayneWade")
...
rownames(FreeThrowAttempts) <- c("KobeBryant","JoeJohnson","LeBronJames","CarmeloAnthony","DwightHoward","ChrisBosh","ChrisPaul","KevinDurant","DerrickRose","DwayneWade")
...
legend(x="bottomleft", legend=Players, pch=15:18, col=c(1:4,6), horiz=F)

FreeThrowAccuracy <- FreeThrows/FreeThrowAttempts

matplot(t(FreeThrowAccuracy), type="b", pch=15:18, col=c(1:4,6))
legend(x="bottomleft", legend=Players, pch=15:18, col=c(1:4,6), horiz=F)
